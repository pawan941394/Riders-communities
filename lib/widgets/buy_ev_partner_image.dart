...
/// Buy-flow avatar / hero images — separate from [RentEvPartnerAvatar].
class BuyEvPartnerAvatar extends StatelessWidget {
  const BuyEvPartnerAvatar({
    super.key,
    required this.plan,
    required this.size,
...
/// 16:9 hero for purchase detail — same layout rules as rent hero, [BuyEvPlan] only.
class BuyEvPartnerHeroImage extends StatelessWidget {
  const BuyEvPartnerHeroImage({
    super.key,
    required this.plan,
